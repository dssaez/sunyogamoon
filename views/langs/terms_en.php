...
<section class="Terms">
        </h2><p><strong>Welcome to <?php echo $Translation['Nombre_web'];?>!</strong></p>
        <p>
                These terms and conditions outline the rules and regulations for the use of <?php echo $Translation['Nombre_web'];?>'s Website.
        </p>
        <p>
                By accessing this website we assume you accept these terms and conditions in full. Do not continue
                to use <?php echo $Translation['Nombre_web'];?>'s website if you do not accept all of the terms and conditions stated on this page.
                ...
                and "Us", refers to our Company. “Party”, “Parties”, or “Us”, refers to both the Client and ourselves, or
                ...
                and subject to, prevailing law of Spain. Any use of the above terminology or other words in the singular,
                plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.
        </p>
        <p><strong>Cookies</strong></p>
        <p>
                We employ the use of cookies. By using web's website you consent to the use of cookies in
                accordance with <?php echo $Translation['Nombre_web'];?>’s privacy policy.
        </p>
        <p>
                ...
                for those people visiting. Some of our affiliate / advertising partners may also use cookies.
        </p>
        <p><strong>License</strong></p>
        <p>
                Unless otherwise stated, <?php echo $Translation['Nombre_web'];?> and/or it’s licensors own the intellectual property rights for all
                material on <?php echo $Translation['Nombre_web'];?>. All intellectual property rights are reserved. You may view and/or print pages
                from http://<?php echo $Translation['URL_web'];?> for your own personal use subject to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
                <li>Republish material from http://<?php echo $Translation['URL_web'];?></li>
                <li>Sell, rent or sub-license material from http:/<?php echo $Translation['URL_web'];?></li>
                <li>Reproduce, duplicate or copy material from http://<?php echo $Translation['URL_web'];?></li>
        </ul>
        <p>Redistribute content from <?php echo $Translation['Nombre_web'];?> (unless content is specifically made for redistribution).</p>
        ...
        <ol>
                ...
                <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                        information, material and data ('Comments') in areas of the website. <?php echo $Translation['Nombre_web'];?> does not screen,
                        edit, publish or review Comments prior to their appearance on the website and Comments do not
                        reflect the views or opinions of <?php echo $Translation['Nombre_web'];?>, its agents or affiliates. Comments reflect the view
                        and opinion of the person who posts such view or opinion. To the extent permitted by applicable
                        laws <?php echo $Translation['Nombre_web'];?> shall not be responsible or liable for the Comments or for any loss cost, liability,
                ...
                <li>
                        <?php echo $Translation['Nombre_web'];?> reserves the right to monitor all Comments and to remove any Comments which it
                ...
                <li>
                        ...
                        <ol>
                                ...
                                <li>The Comments do not infringe any intellectual property right, including without limitation copyright, patent or
                ...
                <li>
                        You hereby grant to <?php echo $Translation['Nombre_web'];?> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use,
        ...
        <ol>
                <li>
                        ...
                        <ul>
                                ...
                                <li>Online directory distributors when they list us in the directory may link to our
                                        Web site in the same manner as they hyperlink to the Web sites of other listed businesses</li>
                ...
                <li>These organizations may link to our home page, to publications or to other Web site information
                        ...
                        the context of the linking party's site</li>
                <li>
                        ...
                        <ul>
                                ...
                                <li>online directory distributor</li>
        ...
        <p> We will approve link requests from these organizations if we determine that: (a) the link would
                not reflect unfavorably on us or our accredited businesses (for example, trade associations or other
                ...
                the benefit to us from the visibility associated with the hyperlink outweighs the absence of <?php echo $Translation['Nombre_web'];?>;
                and (d) where the link is in the context of general resource information or is otherwise consistent with
        ...
        <p>
                ...
                or approval of the linking party and it products or services; and (c) fits within the context of the linking
                party's site.
        </p>
        <p>
                If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                you must notify us by sending an e-mail to <?php echo $Translation['Email'];?>. Please include your name, your
                organization name, contact information (such as a phone number and/or e-mail address) as well as the
                URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s)
        ...
        <p>No use of <?php echo $Translation['Nombre_web'];?>’s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
        ...
        <p>
                ...
                policy at any time. By continuing to link to our Web site, you agree to be bound to and abide by
        ...
        <p>
                ...
                any warranties implied by law in respect of satisfactory quality, fitness for purpose and/or the use
        ...
        <p>
                This Terms and conditions page was created at <a target="_blank" href="http://termsandconditionstemplate.com"> termsandconditionstemplate.com generator. </a>
